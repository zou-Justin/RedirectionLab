...
public class PigLatin{
  ...
  while(n.hasNext()){
      ...
      String stuff = "";
      String content = n.next();
      for (int i = 0; i < line.length();i++){
        stuff += pigLatinBest(content);
      }
  ...
  public static String pigLatinBest(String s){
    String[] Alphabet = new String[]{"a","b","c","C","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
    String[] NumberAlphabet = new String[]{"1","2","3","4","5","6","7","8","9","0","a","b","c","C","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z"};
